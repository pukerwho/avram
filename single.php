...
<div class="container pt-6">
  <div class="flex flex-wrap flex-col lg:flex-row lg:-mx-4 mb-8">
    <div class="w-full lg:w-2/3 lg:px-4 mb-12 lg:mb-0">
        ...
        <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>  
          ...
          <div class="breadcrumbs text-sm text-gray-800 mb-6" itemprop="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
            <ul class="flex items-center flex-wrap -mr-4">
              <li itemprop='itemListElement' itemscope itemtype='https://schema.org/ListItem' class="breadcrumbs_item px-4 pl-6 lg:pl-8">
                <a itemprop="item" href="<?php echo home_url(); ?>" class="text-blue-600 hover:text-red-500">
                  <span itemprop="name"><?php _e( 'Главная', 'treba-wp' ); ?></span>
                </a>                        
                <meta itemprop="position" content="1">
              </li>
              <li itemprop='itemListElement' itemscope itemtype='http://schema.org/ListItem' class="breadcrumbs_item px-4">
                <a itemprop="item" href="<?php echo get_page_url('page-blog'); ?>" class="text-blue-600 hover:text-red-500">
          ...
          <h1 class="text-2xl lg:text-3xl lg:leading-10 font-semobild border-l-4 border-blue-500 pl-4 lg:pl-6 mb-6" itemprop="headline"><?php the_title(); ?></h1>
          ...
          <div class="mb-6">
            <?php if (get_the_post_thumbnail_url()): ?>
              <img src="<?php echo get_the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>" class="w-full h-full xl:h-full object-cover rounded mb-6" itemprop="image">
            <?php endif; ?>
          </div>
      ...
      <div class="text-2xl font-semibold border-l-4 border-blue-500 pl-6 mb-6">
